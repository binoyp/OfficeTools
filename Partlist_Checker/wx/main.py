...
class mainWindow(wx.Frame):
    ...
    def __init__(self,pl):
        ...
        pos=(350,90),label = "Thickness sort")
        # ################################################
        ...
        self.Bind(wx.EVT_BUTTON,self._thknessSort,self._cmdThickness)
...
##        print event.GetEventObject().GetId()
        ...
        self.lstCtr._AddColumn(3,"Thickness")
        self.lstCtr._AddColumn(4,"Description")
        ...
        for eachpart in self.partlist:
            ...
            self.lstCtr.SetStringItem(c,2,str(eachpart[1].Thickness))
            self.lstCtr.SetStringItem(c,3,str(eachpart[1].Description))
...
##    global dbpath
    ...
    if dialog.ShowModal() == wx.ID_OK:
        _Unit =dialog.GetPath()
    dialog.Destroy()
    _fdb = shelve.open(_Unit)
    _dbList = _fdb.keys()
    dlg = wx.SingleChoiceDialog(None,
    'DB',
    'DB Selection',
